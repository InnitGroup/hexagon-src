// bundle: studio___b3c2e972589c9f8845c09d90bc477f64_m
// files: jquery/jquery-1.11.1.min.js, jquery/jquery-migrate-1.2.1.min.js, roblox.js, jquery.tipsy.js, GoogleAnalytics/GoogleAnalyticsEvents.js, jquery.cookie.js, common/forms.js, jquery.simplemodal-1.3.5.js, GenericConfirmation.js, JavaScriptEndpoints.js, common/forms.js
...
;(function (n) {
	...
	function r(n) {
		while ((n = n.parentNode)) if (n == document) return !0
		return !1
	}
	function i(t, i) {
	...
	;(i.prototype = {
		show: function () {
			...
			if (s && this.enabled) {
				...
				switch (f.charAt(0)) {
					case 'n':
						u = { top: i.top + i.height + this.options.offset, left: i.left + i.width / 2 - e / 2 }
						break
					case 's':
						u = { top: i.top - o - this.options.offset, left: i.left + i.width / 2 - e / 2 }
						break
					case 'e':
						u = { top: i.top + i.height / 2 - o / 2, left: i.left - e - this.options.offset }
						break
					case 'w':
						u = { top: i.top + i.height / 2 - o / 2, left: i.left + i.width + this.options.offset }
				}
				f.length == 2 &&
					(u.left = f.charAt(1) == 'w' ? i.left + i.width / 2 - 15 : i.left + i.width / 2 - e + 15),
		...
		fixTitle: function () {
			var n = this.$element
			;(n.attr('title') || typeof n.attr('original-title') != 'string') &&
				n.attr('original-title', n.attr('title') || '').removeAttr('title')
		},
		getTitle: function () {
			var i = this.$element,
				n = this.options,
			...
			return (
				...
				typeof n.title == 'string'
					? (t = i.attr(n.title == 'title' ? 'original-title' : n.title))
					: typeof n.title == 'function' && (t = n.title.call(i[0])),
				(t = ('' + t).replace(/(^\s*|\s*$)/, '')),
				t || n.fallback
			)
		},
		tip: function () {
			return (
				this.$tip ||
					((this.$tip = n('<div class="tipsy"></div>').html(
		...
		(n.fn.tipsy = function (t) {
			...
			if (
				((t = n.extend({}, n.fn.tipsy.defaults, t)),
				t.live ||
					this.each(function () {
						u(this)
					}),
		...
		(n.fn.tipsy.autoBounds = function (t, i) {
			return function () {
				var r = { ns: i[0], ew: i.length > 1 ? i[1] : !1 },
					f = n(document).scrollTop() + t,
					e = n(document).scrollLeft() + t,
					u = n(this)
				return (
					u.offset().top < f && (r.ns = 'n'),
...
})(jQuery) // GoogleAnalytics/GoogleAnalyticsEvents.js
...
var GoogleAnalyticsEvents = {
	...
	SetCustomVar: function (n, t, i, r) {
		window._gaq &&
			(window.GoogleAnalyticsDisableRoblox2 || _gaq.push(['_setCustomVar', n, t, i, r]),
			_gaq.push(['b._setCustomVar', n, t, i, r]))
	},
	FireEvent: function (n) {
		var t, i
		window._gaq &&
			(window.GoogleAnalyticsDisableRoblox2 ||
				((t = ['_trackEvent']),
				(t = t.concat(n)),
				_gaq.push(t),
	...
	TrackTransaction: function (n, t) {
		if (window._gaq) {
			...
			window.GoogleAnalyticsDisableRoblox2 ||
				(_gaq.push(i), GoogleAnalyticsEvents.LocalEventLog.push(makeGoogleAnalyticsLogObject(i))),
				(i[0] = 'b.' + i[0]),
				_gaq.push(i),
				GoogleAnalyticsEvents.LocalEventLog.push(makeGoogleAnalyticsLogObject(i))
		}
...
;(function (n) {
	...
	var r = [],
		...
		f = n(window),
		i = [],
		t = { ieQuirks: null, msie: /msie/.test(u) && !/opera/.test(u), opera: /opera/.test(u) }
	;(t.ie6 = t.msie && /msie 6./.test(u) && typeof window.XMLHttpRequest != 'object'),
		...
		(n.modal.impl = {
			...
			init: function (i, r) {
				...
				if (
					((t.ieQuirks = t.msie && !(n.support.boxModel === undefined) && !n.support.boxModel),
			...
			create: function (u) {
				...
				f.getDimensions(),
					f.o.modal &&
						t.ie6 &&
						(f.d.iframe = n('<iframe src="javascript:false;"></iframe>')
							.css(
								n.extend(f.o.iframeCss, {
									display: 'none',
									opacity: 0,
									position: 'fixed',
									height: i[0],
					...
					(f.d.overlay = n('<div></div>')
						.attr('id', f.o.overlayId)
						.addClass('simplemodal-overlay')
						.css(
							n.extend(f.o.overlayCss, {
								display: 'none',
						...
						.appendTo(f.o.appendTo)),
					(f.d.container = n('<div></div>')
						.attr('id', f.o.containerId)
						.addClass('simplemodal-container')
						.css(
							n.extend({ position: f.o.fixed ? 'fixed' : 'absolute' }, f.o.containerCss, {
								display: 'none',
								zIndex: f.o.zIndex + 2
							})
						)
						.append(f.o.close && f.o.closeHTML ? n(f.o.closeHTML).addClass(f.o.closeClass) : '')
						.appendTo(f.o.appendTo)),
					(f.d.wrap = n('<div></div>')
						.attr('tabIndex', -1)
					...
					(f.d.data = u
						.attr('id', u.attr('id') || f.o.dataId)
						.addClass('simplemodal-data')
						.css(n.extend(f.o.dataCss, { display: 'none' }))
						.appendTo('body')),
					(u = null),
			...
			bindEvents: function () {
				...
				n('.' + u.o.closeClass).bind('click.simplemodal', function (n) {
					...
					u.o.modal &&
						u.o.close &&
						u.o.overlayClose &&
						u.d.overlay.bind('click.simplemodal', function (n) {
							n.preventDefault(), u.close()
						}),
					e.bind('keydown.simplemodal', function (n) {
						u.o.modal && n.keyCode === 9
							? u.watchTab(n)
							: u.o.close && u.o.escClose && n.keyCode === 27 && (n.preventDefault(), u.close())
					}),
					f.bind('resize.simplemodal orientationchange.simplemodal', function () {
						u.getDimensions(),
							...
							t.ie6 || t.ieQuirks
								? u.fixIE()
								: u.o.modal &&
									(u.d.iframe && u.d.iframe.css({ height: i[0], width: i[1] }),
									u.d.overlay.css({ height: r[0], width: r[1] }))
					})
			},
			...
			fixIE: function () {
				...
				n.each(
					[
						i.d.iframe || null,
						i.o.modal ? i.d.overlay : null,
						i.d.container.css('position') === 'fixed' ? i.d.container : null
					],
					function (n, i) {
						var l, a, e, o
						if (i) {
												...
												(l =
													e.indexOf('%') === -1
														...
														: parseInt(e.replace(/%/, '')) +
															...
															') + "px"'),
												t[1] &&
													((o = typeof t[1] == 'number' ? t[1].toString() : t[1].replace(/px/, '')),
													(a =
														o.indexOf('%') === -1
															? o + ' + (t = ' + f + ' ? ' + f + ' : ' + c + ') + "px"'
															: parseInt(o.replace(/%/, '')) +
				...
				return n
					? typeof n == 'number'
						...
						: n === 'auto'
							? 0
							: n.indexOf('%') > 0
								? (parseInt(n.replace(/%/, '')) / 100) * (t === 'h' ? i[0] : i[1])
			...
			setContainerDimensions: function () {
				var n = this,
					...
					r = n.d.origHeight
						? n.d.origHeight
						: t.opera
							? n.d.container.height()
							: n.getVal(
									v ? n.d.container[0].currentStyle.height : n.d.container.css('height'),
									'h'
								),
					u = n.d.origWidth
						? n.d.origWidth
						: t.opera
							? n.d.container.width()
							: n.getVal(v ? n.d.container[0].currentStyle.width : n.d.container.css('width'), 'w'),
				...
				;(r = r
					...
					(u = u
						...
						: s
							? s > c
								? c
								: n.o.minWidth && f !== 'auto' && s < f
									? f
									: s
							: f),
					n.d.container.css({ height: r, width: u }),
					n.d.wrap.css({ overflow: o > r || s > u ? 'auto' : 'visible' }),
			...
			setPosition: function () {
				var n = this,
					t,
					r,
					u = i[0] / 2 - n.d.container.outerHeight(!0) / 2,
				...
				n.o.position && Object.prototype.toString.call(n.o.position) === '[object Array]'
					? ((t = o + (n.o.position[0] || u)), (r = n.o.position[1] || e))
					: ((t = o + u), (r = e)),
					n.d.container.css({ left: r, top: t })
			},
			watchTab: function (t) {
				var i = this,
					r
				n(t.target).parents('.simplemodal-container').length > 0
					? ((i.inputs = n(
						...
						((!t.shiftKey && t.target === i.inputs[i.inputs.length - 1]) ||
							...
							i.inputs.length === 0) &&
							(t.preventDefault(), (r = t.shiftKey ? 'last' : 'first'), i.focus(r)))
...
typeof Roblox == typeof undefined && (Roblox = {}),
	(Roblox.Endpoints = Roblox.Endpoints || { addCrossDomainOptionsToAllRequests: !1 }),
	...
	(Roblox.Endpoints.splitAtQueryString = function (n) {
		...
		return t === null
			? { url: n, query: '' }
			: { url: n.substring(0, t.index), query: n.substring(t.index) }
	}),
	(Roblox.Endpoints.ajaxPrefilter = function (n) {
		...
		;(n.url = r),
			Roblox.Endpoints.addCrossDomainOptionsToAllRequests &&
				n.url.indexOf('hexagon.pw') < 0 &&
				n.url.indexOf('s3.amazonaws.com') < 0 &&
				((n.crossDomain = !0),
	...
	(Roblox.Endpoints.generateAbsoluteUrl = function (n, t, i) {
		var f = Roblox.Endpoints.splitAtQueryString(n),
			...
			r = u
		return (
			typeof Roblox.Endpoints.Urls != typeof undefined &&
				i &&
				typeof Roblox.Endpoints.Urls[u.toLowerCase()] != typeof undefined &&
				(r = Roblox.Endpoints.getAbsoluteUrl(u)),
			r.indexOf('{') > -1 &&
				$.each(t, function (n, t) {
	...
	(Roblox.Endpoints.getAbsoluteUrl = function (n) {
		var t, r, i, u
		return typeof Roblox.Endpoints.Urls == typeof undefined
			? n
			: n.length === 0 || Roblox.Endpoints.isAbsolute(n)
				? n
				: (n.indexOf('/') !== 0 &&
					  ...
					  i === undefined)
					? ((u = window.location.protocol + '//' + window.location.hostname), u + n)
					: i
	}),
	(function () {
		function n(n) {
	...
	$.ajaxPrefilter(Roblox.Endpoints.ajaxPrefilter) // common/forms.js
...
Roblox && Roblox.BundleDetector && Roblox.BundleDetector.bundleDetected('studio')
