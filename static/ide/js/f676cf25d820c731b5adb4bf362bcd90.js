...
Roblox.define(
	...
	function () {
		...
		function u(n, t) {
			...
			t.bcOverlayUrl != null &&
				((o = $('<img>')
					...
					.attr('border', 0)),
				n.after(o)),
				t.transparentBackground === !0 && n.addClass('checker-background-small'),
		...
		var t = { selector: '.roblox-item-image', endpoint: '/thumbs/itemimage.ashx?jsoncallback=?' }
