// bundle: idewelcomepage___439f36a9d374a30af3d4540753b88f8b_m
// files: roblox.js, GoogleAnalytics/GoogleAnalyticsEvents.js, EventTracker.js, PlaceLauncher.js, ClientInstaller.js, jquery.simplemodal-1.3.5.js, GenericModal.js, GenericConfirmation.js, jquery.ba-postmessage.min.js, parentFrameLogin.js, IDE/Welcome.js, IDE/BuildTemplates.js, StringTruncator.js

// roblox.js
;(function (n, t) {
	function p(n, i) {
		var r = i.split('.')
		for (i = r.shift(); r.length > 0; n = n[i], i = r.shift()) if (n[i] === t) return t
		return n[i]
	}
	function k(n, i, r) {
		var u = i.split('.')
			...
			(i.onload = i.onreadystatechange =
				function () {
					;(i.readyState && i.readyState != 'loaded' && i.readyState != 'complete') ||
						(t(), (i.onload = i.onreadystatechange = null))
				}),
			u.parentNode.insertBefore(i, u)
	}
	function d(n) {
	...
	function o(n) {
		...
		if (n.indexOf(r.modulePath) >= 0)
			return n
				...
				.shift()
				.replace('/', '.')
		for (var t in r.paths) if (r.paths[t] == n) return t
		return n
	}
	function v(n) {
		return n.indexOf('.js') >= 0 || n.indexOf('.css') >= 0
			? n
			: r.paths[n] || r.baseUrl + r.modulePath + '/' + n.replace('.', '/') + '.js'
	}
	function s(n) {
	...
	function e(n) {
		var t = i[n]
		if (t.loaded && t.depsLoaded) while (t.listeners.length > 0) t.listeners.shift()()
	}
	function a(n, u) {
		var f, s, h
		...
		;(f = o(n)),
			i[f] === t
				? ((i[f] = { loaded: !1, depsLoaded: !0, listeners: [] }),
					i[f].listeners.push(u),
					(s = v(f)),
					(h = d(s) == 'css' ? nt : g),
					h(s, function () {
						;(i[f].loaded = !0), e(f)
	...
	function y(n, t, r) {
		w(t) ? ((r = t), (t = [])) : c(t) || (t = [t]),
			(i[n] = i[n] || { loaded: !0, listeners: [] }),
			(i[n].depsLoaded = !1),
			i[n].listeners.unshift(function () {
	...
	var f = n.document,
		...
		i = {},
		r = { baseUrl: '', modulePath: '/js/modules', paths: {}, externalResources: [] }
	typeof Roblox == 'undefined' &&
		((Roblox = {}), (Roblox.config = r), (Roblox.require = l), (Roblox.define = y))
})(window) // GoogleAnalytics/GoogleAnalyticsEvents.js
...
var RBX = {},
	...
	RobloxPlaceLauncherService = {
		...
		RequestGame: function (n, t, i, r, u, f) {
			;(i = i !== null && i !== undefined ? i : ''),
				$.getJSON(
					...
					{ request: 'RequestGame', placeId: n, isPartyLeader: t, gender: i },
					function (n) {
		...
		RequestPlayWithParty: function (n, t, i, r, u, f) {
			$.getJSON(
				'/Game/PlaceLauncher.ashx',
				{ request: 'RequestPlayWithParty', placeId: n, partyGuid: t, gameId: i },
				function (n) {
					n.Error ? u(n.Error, f) : r(n, f)
				}
			)
		...
		RequestGroupBuildGame: function (n, t, i, r) {
			$.getJSON(
				'/Game/PlaceLauncher.ashx',
				{ request: 'RequestGroupBuildGame', placeId: n },
				function (n) {
		...
		RequestFollowUser: function (n, t, i, r) {
			$.getJSON(
				'/Game/PlaceLauncher.ashx',
				{ request: 'RequestFollowUser', userId: n },
				function (n) {
					n.Error ? i(n.Error, r) : t(n, r)
				}
			)
		...
		RequestGameJob: function (n, t, i, r, u) {
			$.getJSON(
				'/Game/PlaceLauncher.ashx',
				{ request: 'RequestGameJob', placeId: n, gameId: t },
				function (n) {
		...
		CheckGameJobStatus: function (n, t, i, r) {
			$.getJSON(
				'/Game/PlaceLauncher.ashx',
				{ request: 'CheckGameJobStatus', jobId: n },
				function (n) {
					n.Error ? i(n.Error, r) : t(n, r)
				}
			)
...
;(RobloxLaunch.RequestPlayWithParty = function (n, t, i, r) {
	...
	(RobloxLaunch.StartGameWork = function (n, t, i, r, u) {
		...
		;(i = i.replace('http://', 'https://')),
			n.indexOf('http') >= 0 &&
				(n =
					typeof RobloxLaunch.SeleniumTestMode == 'undefined'
						? n + '&testmode=false'
						: n + '&testmode=true'),
			...
			return (
				Roblox.Client.isRobloxBrowser()
					? typeof urchinTracker != 'undefined' &&
						urchinTracker('Visit/Fail/' + o + encodeURIComponent(e))
					: (typeof urchinTracker != 'undefined' &&
							urchinTracker('Visit/Redirect/' + o + encodeURIComponent(e)),
	...
	(RobloxLaunch.CheckGameStarted = function (n) {
		function r() {
			try {
				if (
					...
					i &&
						!u &&
						(EventTracker.endSuccess('StartClient'), EventTracker.endSuccess('Launch'), (u = !0)),
		...
		var u = !1,
			...
			i
		t === null &&
			((t = new RBX.PlaceLauncher('PlaceLauncherStatusPanel')),
			t._showDialog(),
			t._updateStatus(0)),
			(i = !1),
			r()
	...
	(RBX.PlaceLauncher.prototype = {
		_showDialog: function () {
			...
			;(this._cancelled = !1),
				...
				this._popupID == 'PlaceLauncherStatusPanel' &&
					(Roblox.VideoPreRoll &&
					Roblox.VideoPreRoll.showVideoPreRoll &&
					!Roblox.VideoPreRoll.isExcluded()
		...
		_onGameStatus: function (n) {
			...
			if ((this._updateStatus(n.status), n.status === 2))
				...
				n.status === 4 &&
					(EventTracker.endFailure('GetConnection'), EventTracker.endFailure('Launch'))
		},
		_updateStatus: function (n) {
			MadStatus.running ||
				(MadStatus.init(
					$(this._popup).find('.MadStatusField'),
					$(this._popup).find('.MadStatusBackBuffer'),
					2e3,
					800
				),
				MadStatus.start())
		...
		RequestGame: function (n, t) {
			...
			return (
				typeof Party != 'undefined' &&
					typeof Party.AmILeader == 'function' &&
					(i = Party.AmILeader()),
				(r = function () {
		...
		RequestPrivateGame: function (n, t, i) {
			...
			var f = function (n, t) {
				...
				u = function () {
					EventTracker.start('GetConnection'),
						RobloxPlaceLauncherService.RequestPrivateGame(n, t, i, f, e, r)
				}
		...
		RequestGameJob: function (n, t) {
			...
			var u = function (n, t) {
				...
				r = function () {
					EventTracker.start('GetConnection'),
						RobloxPlaceLauncherService.RequestGameJob(n, t, u, f, i)
				}
			return this._startUpdatePolling(r), !1
		},
...
Type.registerNamespace('Roblox.Client'),
	...
	(Roblox.Client.ReleaseLauncher = function (n, t, i) {
		if (
			...
			(i || Roblox.Client._numLocks <= 0) &&
				(n != null && ((document.getElementById('pluginObjDiv').innerHTML = ''), (n = null)),
				(Roblox.Client._numLocks = 0)),
	...
	(Roblox.Client.isIDE = function () {
		if (
			Roblox.Client._isIDE == null &&
			((Roblox.Client._isIDE = !1), (Roblox.Client._isRobloxBrowser = !1), window.external)
		)
			try {
				window.external.IsRobloxAppIDE !== undefined &&
					((Roblox.Client._isIDE = window.external.IsRobloxAppIDE),
					(Roblox.Client._isRobloxBrowser = !0))
			} catch (n) {}
	...
	(Roblox.Client.IsRobloxProxyInstalled = function () {
		var t = Roblox.Client.CreateLauncher(!1),
			n = !1
		return (t != null && (n = !0),
		Roblox.Client.ReleaseLauncher(t, !1, !1),
		n || Roblox.Client.isRobloxBrowser())
			? !0
			: !1
	}),
	(Roblox.Client.IsRobloxInstalled = function () {
		try {
			...
			return Roblox.Client.isRobloxBrowser()
				? ((n = Roblox.Client.robloxBrowserInstallHost()), n == Roblox.Client._installHost)
				: !1
		}
	}),
				...
				!Roblox.Client.IsRobloxProxyInstalled() && Roblox.Client.ImplementsProxy
					? (EventTracker.start('InstallClient'),
						...
						typeof _gaq != typeof undefined &&
							(_gaq.push(['_trackEvent', 'Install Begin', t]),
							_gaq.push(['b._trackEvent', 'Install Begin', t])),
						RobloxEventManager.triggerEvent('rbx_evt_install_begin', { os: t }),
						window.chrome &&
							((window.location.hash = '#chromeInstall'),
							$.cookie(
								'chromeInstall',
								n.toString().replace(/play_placeId/, play_placeId.toString())
							)),
	...
	;(n.modal = function (t, i) {
		...
		(n.modal.impl = {
			...
			init: function (t, i) {
				...
				if (
					((r.o = n.extend({}, n.modal.defaults, i)),
					(r.zIndex = r.o.zIndex),
					(r.occb = !1),
					typeof t == 'object')
				)
					(t = t instanceof jQuery ? t : n(t)),
						(r.d.placeholder = !1),
						t.parent().parent().size() > 0 &&
							(t.before(
								n('<span></span>').attr('id', 'simplemodal-placeholder').css({ display: 'none' })
							),
							(r.d.placeholder = !0),
							(r.display = t.css('display')),
							r.o.persist || (r.d.orig = t.clone(!0)))
				...
				return (
					...
					(t = null),
					r.open(),
					n.isFunction(r.o.onShow) && r.o.onShow.apply(r, [r.d]),
					r
				)
			},
			create: function (r) {
				...
				;(t = u.getDimensions()),
					u.o.modal &&
						i &&
						(u.d.iframe = n('<iframe src="javascript:false;"></iframe>')
							.css(
								n.extend(u.o.iframeCss, {
									display: 'none',
									opacity: 0,
									position: 'fixed',
									height: t[0],
							...
							.appendTo(u.o.appendTo)),
					(u.d.overlay = n('<div></div>')
						.attr('id', u.o.overlayId)
						.addClass('simplemodal-overlay')
						.css(
							n.extend(u.o.overlayCss, {
								display: 'none',
						...
						.appendTo(u.o.appendTo)),
					(u.d.container = n('<div></div>')
						.attr('id', u.o.containerId)
						.addClass('simplemodal-container')
						.css(
							n.extend(u.o.containerCss, {
								display: 'none',
								position: 'fixed',
								zIndex: u.o.zIndex + 2
							})
						)
						.append(u.o.close && u.o.closeHTML ? n(u.o.closeHTML).addClass(u.o.closeClass) : '')
						.appendTo(u.o.appendTo)),
					(u.d.wrap = n('<div></div>')
						.attr('tabIndex', -1)
						.addClass('simplemodal-wrap')
						.css({ height: '100%', outline: 0, width: '100%', overflow: 'visible' })
						.appendTo(u.d.container)),
					(u.d.data = r
						.attr('id', r.attr('id') || u.o.dataId)
						.addClass('simplemodal-data')
						.css(n.extend(u.o.dataCss, { display: 'none' }))
						.appendTo('body')),
					(r = null),
					u.setContainerDimensions(),
					u.d.data.appendTo(u.d.wrap),
					i && u.fixIE()
			},
			bindEvents: function () {
				var r = this
				n('.' + r.o.closeClass).bind('click.simplemodal', function (n) {
					...
					r.o.modal &&
						r.o.close &&
						r.o.overlayClose &&
						r.d.overlay.bind('click.simplemodal', function (n) {
							n.preventDefault(), r.close()
						}),
					n(document).bind('keydown.simplemodal', function (n) {
						r.o.modal && r.o.focus && n.keyCode == 9
							? r.watchTab(n)
							: r.o.close && r.o.escClose && n.keyCode == 27 && (n.preventDefault(), r.close())
					}),
					n(window).bind('resize.simplemodal', function () {
						;(t = r.getDimensions()),
							r.setContainerDimensions(!0),
							i
								? r.fixIE()
								: r.o.modal &&
									(r.d.iframe && r.d.iframe.css({ height: t[0], width: t[1] }),
									r.d.overlay.css({ height: t[0], width: t[1] }))
					})
			},
			unbindEvents: function () {
				n('.' + this.o.closeClass).unbind('click.simplemodal'),
					n(document).unbind('keydown.simplemodal'),
					n(window).unbind('resize.simplemodal'),
			...
			fixIE: function () {
				var i = this,
					t = i.o.position
				n.each(
					[i.d.iframe || null, i.o.modal ? i.d.overlay : null, i.d.container],
					function (n, i) {
						var l, c, o, e
						if (i) {
												...
												(l =
													o.indexOf('%') == -1
														...
														: parseInt(o.replace(/%/, '')) +
															...
															') + "px"'),
												t[1] &&
													((e = typeof t[1] == 'number' ? t[1].toString() : t[1].replace(/px/, '')),
													(c =
														e.indexOf('%') == -1
															? e + ' + (t = ' + u + ' ? ' + u + ' : ' + a + ') + "px"'
															: parseInt(e.replace(/%/, '')) +
			...
			getDimensions: function () {
				var t = n(window),
					i =
						n.browser.opera && n.browser.version > '9.5' && n.fn.jquery <= '1.2.6'
							...
							: h
								? h > o
									...
									: h < r.o.minWidth
										...
										: h
								: r.o.minWidth),
						r.d.container.css({ height: f, width: u })
				}
			...
			setPosition: function () {
				...
				n.o.position && Object.prototype.toString.call(n.o.position) === '[object Array]'
					? ((r = n.o.position[0] || f), (i = n.o.position[1] || u))
					: ((r = f), (i = u)),
					n.d.container.css({ left: i, top: r })
			},
			watchTab: function (t) {
				var i = this,
					r
				n(t.target).parents('.simplemodal-container').length > 0
					? ((i.inputs = n(
							':input:enabled:visible:first, :input:enabled:visible:last',
							i.d.data[0]
						)),
						((!t.shiftKey && t.target == i.inputs[i.inputs.length - 1]) ||
							(t.shiftKey && t.target == i.inputs[0]) ||
							i.inputs.length == 0) &&
							(t.preventDefault(),
			...
			open: function () {
				...
				t.d.iframe && t.d.iframe.show(),
					n.isFunction(t.o.onOpen)
						? t.o.onOpen.apply(t, [t.d])
						: (t.d.overlay.show(), t.d.container.show(), t.d.data.show()),
					t.focus(),
					t.bindEvents()
			},
			close: function () {
				...
				t.unbindEvents(),
					n.isFunction(t.o.onClose) && !t.occb
						? ((t.occb = !0), t.o.onClose.apply(t, [t.d]))
						: (t.d.placeholder
								? ((i = n('#simplemodal-placeholder')),
									t.o.persist
										? i.replaceWith(
												t.d.data.removeClass('simplemodal-data').css('display', t.display)
											)
										: (t.d.data.hide().remove(), i.replaceWith(t.d.orig)))
								: t.d.data.hide().remove(),
							t.d.container.hide().remove(),
							t.d.overlay.hide().remove(),
							t.d.iframe && t.d.iframe.hide().remove(),
							(t.d = {}))
			}
		})
})(jQuery) // GenericModal.js
	...
	(Roblox.GenericModal = (function () {
		function i(t, i, u, f, e) {
			...
			o.find('div.Title').text(t),
				i === null
					? o.addClass('noImage')
					: (o.find('img.GenericModalImage').attr('src', i), o.removeClass('noImage')),
	...
	$('#header-login').click(function (i) {
		...
		(t = function (n) {
			$('.IframeAdHide').each(function () {
				$(this).height() == 90 &&
					$(this).width() == 728 &&
					(n ? $(this).css('visibility', 'hidden') : $(this).css('visibility', 'visible'))
			})
		}),
		(i = function (n) {
			var t, i
			n.indexOf('resize') != -1 && ((t = n.split(',')), $('#iFrameLogin').css({ height: t[1] })),
				n.indexOf('fbRegister') != -1 &&
					((t = n.split('^')),
					(i =
						'&fbname=' +
						...
						'&fbdt=' +
						encodeURIComponent(t[3])),
					(window.location.href = '../Login/Default.aspx?iFrameFacebookSync=true' + i))
		}),
		$.receiveMessage(function (n) {
			i(n.data)
		}),
		$('#header-login-wrapper').data('display-opened') == 'True' &&
			($('#header-login').addClass('active'), $('#iFrameLogin').css('display', 'block'))
}) // IDE/Welcome.js
...
$(function () {
	...
	$(window).resize(function () {
		...
		$('#PublishedProjects').length > 0
			? $('#MyProjects').addClass('navselected')
			: $('.navlist li').first().addClass('navselected'),
		...
		$('.place').click(function () {
			...
			n.hasClass('app-place') &&
				...
				n.hasClass('place-selected')
					? (n.removeClass('place-selected'), $('div#ButtonRow').hide())
					: ($('.place.place-selected').removeClass('place-selected'),
						n.addClass('place-selected'),
						$('div#ButtonRow').show())
		}),
		$('.place a').removeAttr('href'),
...
function getSelectedTemplateType() {
	return $(
		'div.templates[js-data-templatetype="' +
			$('ul.templatetypes li.selectedType').attr('js-data-templatetype') +
			'"]'
	)
}
$(function () {
...
function fitStringToWidth(n, t, i) {
	...
	var f, r, u, e, o
	if (
		(isInitialized || InitStringTruncator(),
		i && (fitStringSpan.className = i),
		(f = s(n)),
		(fitStringSpan.innerHTML = f),
		fitStringSpan.offsetWidth > t)
	) {
		for (r = 0, e = n.length; (o = (e - r) >> 1); )
			(u = r + o),
				(fitStringSpan.innerHTML = s(n.substring(0, u)) + '&hellip;'),
				fitStringSpan.offsetWidth > t ? (e = u) : (r = u)
