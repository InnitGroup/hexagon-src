...
<div class="flex w-full">
	<div class="w-full max-w-[300px] flex-col gap-y-4 xl:flex hidden basis-0 grow m-20"></div>

	<div class="container p-4">
		<div class="flex flex-row gap-x-8 flex-wrap md:flex-nowrap mx-auto p-4">
	...
	<div class="w-full max-w-[300px] flex-col gap-y-4 xl:flex hidden basis-0 grow aspect-square m-20">
		<UserImage type="rectangle" />
