		...
		<nav class="flex items-center space-x-3 sm:space-x-4 lg:space-x-6 w-full">
			<div class="flex items-center space-x-3 sm:space-x-4 lg:space-x-6 w-full">
				<a href={loggedIn === false ? '/' : '/home'}
					><img alt="H" class="hidden md:block md:w-36 max-w-xs mr-0 ml-6 hexagon-logo" src="/hexagonfull.png" />
					<img alt="H" class="md:hidden w-8 md:w-12 max-w-xs mr-0 ml-6 hexagon-logo" src="/hexagon128.png" />
				</a>
