<script lang="ts">
	...
	import type { FormSchema as ClothingSchema } from '$lib/schemas/edit/editclothingschema'

	import { formSchema as clothingSchema } from '$lib/schemas/edit/editclothingschema'
