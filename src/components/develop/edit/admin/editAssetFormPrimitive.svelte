<script lang="ts">
	...
	import type { FormSchema as AssetSchema } from '$lib/schemas/edit/admin/editassetschema'

	import { formSchema as assetSchema } from '$lib/schemas/edit/admin/editassetschema'
